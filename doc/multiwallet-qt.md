...
In order to support loading of multiple wallets in apollon-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is apollon.cpp.
...
Changes to apollon.cpp
----------------------
apollon.cpp is the entry point into apollon-qt, and as such, will require some minor modifications to provide hooks for
