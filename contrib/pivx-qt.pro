...
RESOURCES += src/qt/apollon.qrc src/qt/apollon_locale.qrc

TRANSLATIONS += src/qt/locale/apollon_bg.ts \
                src/qt/locale/apollon_de.ts \
                src/qt/locale/apollon_en.ts \
                src/qt/locale/apollon_es.ts \
                src/qt/locale/apollon_fi.ts \
                src/qt/locale/apollon_fr.ts \
                src/qt/locale/apollon_it.ts \
                src/qt/locale/apollon_ja.ts \
                src/qt/locale/apollon_pl.ts \
                src/qt/locale/apollon_pt.ts \
                src/qt/locale/apollon_ru.ts \
                src/qt/locale/apollon_sk.ts \
                src/qt/locale/apollon_sv.ts \
                src/qt/locale/apollon_vi.ts \
                src/qt/locale/apollon_zh_CN.ts \
                src/qt/locale/apollon_zh_TW.ts
