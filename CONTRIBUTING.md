Contributing to Apollon Core
============================

The Apollon Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Apollon Core project, and is not to be
confused with overall Apollon Network Protocol consensus changes.

Whether a pull request is merged into Apollon Core rests with the project merge
...
Patches that change Apollon consensus rules are considerably more involved than
...
Where a patch set proposes to change the Apollon consensus, it must have been
...
The project leader is the release manager for each Apollon Core release.
