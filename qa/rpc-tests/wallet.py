...
#   c) node1 mines 32 blocks, so now node 0 has 60001xap, node 1 has 4250xap, node2 has none.
#   d) node0 sends 601 xap to node2, in two transactions (301 xap, then 300 xap).
